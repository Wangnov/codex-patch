    ...
    fn reconstructs_tool_items_from_persisted_completion_events() {
        let events = vec![
            ...
            EventMsg::ExecCommandEnd(ExecCommandEndEvent {
                ...
                what: Some("print greeting text".into()),
                why: Some("verify thread history preserves WHAT and WHY".into()),
                stdout: String::new(),
                stderr: String::new(),
    ...
    fn assigns_late_exec_completion_to_original_turn() {
        let events = vec![
            ...
            EventMsg::ExecCommandEnd(ExecCommandEndEvent {
                ...
                source: ExecCommandSource::Agent,
                interaction_input: None,
                what: Some("print completion marker".into()),
                why: Some("verify late command items keep WHAT and WHY".into()),
                stdout: "done\n".into(),
                stderr: String::new(),
